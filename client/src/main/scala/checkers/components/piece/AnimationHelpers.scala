...
object AnimationHelpers {
  ...
  private lazy val entryPointA = Board.squareCenter(2) + Point(1, 1)
  private lazy val entryPointB = Board.squareCenter(3) + Point(1, 1)
  private lazy val entryPointC = Board.squareCenter(29) - Point(1, 1)
  private lazy val entryPointD = Board.squareCenter(28) - Point(1, 1)
